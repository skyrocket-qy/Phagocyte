...
{
    public static readonly Color ColorNormal = new(0.18f, 0.72f, 0.45f, 0.65f);
    public static readonly Color ColorBurst = new(0.60f, 1.0f, 0.40f, 0.90f);
    public static readonly Color MembraneNormal = new(0.40f, 0.95f, 0.65f, 0.95f);
    public static readonly Color MembraneBurst = new(0.85f, 1.0f, 0.60f, 1.0f);
    ...
    public override void SetupNucleusShape()
    {
        ...
        if (Nucleus != null)
        {
            ...
            Nucleus.Color = new Color(0.10f, 0.35f, 0.22f, 0.90f);
        }
    }
