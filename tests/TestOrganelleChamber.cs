...
public partial class TestOrganelleChamber : TestHarness
{
    ...
    private void RunTranslationTests()
    {
        ...
        foreach (string key in new[]
        {
            ...
            "LOADOUT_CONFIRM", "LOADOUT_RESET", "LOADOUT_CATEGORY_ALL",
            "LOADOUT_EQUIPPED_TAG", "LOADOUT_HINT_DEFAULT",
            "LOADOUT_HINT_SLOTS_FULL", "LOADOUT_HINT_OVERLOAD",
            "LOADOUT_HINT_COPY_CAP", "LOADOUT_HINT_UNKNOWN", "LOADOUT_HINT_BAD_SLOT",
            "LOADOUT_VAULT_PROGRESS", "LOADOUT_HINT_LOCKED",
