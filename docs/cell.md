...
| **殺手 T 細胞** | `ctl` | $7 \sim 10\,\mu\text{m}$ | **緊湊微絨毛球體**。平滑圓整，高頻微幅顫動；衝刺時前端極化為免疫突觸。 | **超大正圓形核**（佔據體內 $\sim 80\%$ 空間，僅留薄層胞質）。 | **穿孔素長矛**<br>(Perforin Lance) | **【殺手 T 起點中心】**<br>(右側 · 移速/暴擊/穿透/閃避) | 單局吞噬消滅 200 隻病原體<br>(`engulf_20`) |
| **嗜中性球** | `neutrophil` | $10 \sim 15\,\mu\text{m}$ | **高頻焦躁顫膜**。邊界極不穩定，易破碎呈顆粒狀；胞質密布細微殺菌顆粒。 | **分節多葉核（3～5 葉）**（呈念珠或香腸串狀）。 | **顆粒酶殉爆**<br>(Granzyme Detonation) | **【嗜中性球起點中心】**<br>(左側 · 傷害/擊退/自癒) | 單局吞噬消滅 500 隻病原體<br>(`devour_50`) |
