...
| **B 淋巴細胞** | `b_cell` | $8 \sim 12\,\mu\text{m}$ | **受體密布圓球**。靜息時緊湊圓潤，外圍環繞 Y 型受體；活化時內質網如工廠展開。 | **車輪狀 / 鐘面狀核**（染色質呈輪輻放射狀排列）。 | **Y 型抗體齊射**<br>(Antibody Salvo) | **【B 細胞起點中心】**<br>(右下 · 彈道數/彈速/CDR) | 單局細胞達到等級 15<br>(`ach_reach_level_5`) |
