...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **巨噬細胞** | `macrophage` | $20 \sim 40\,\mu\text{m}$ | **流體阿米巴狀**。邊界劇烈起伏，粗大偽足持續伸張，體內可見深色溶酶體泡。 | **巨大腎形 / 馬蹄形單核**（偏心排列）。 | **微絲變形**<br>(Macrophage Deformation) | **【巨噬起點中心】**<br>(左上 · 體積/血量/護甲) | **預設解鎖** |
| **殺手 T 細胞** | `ctl` | $7 \sim 10\,\mu\text{m}$ | **緊湊微絨毛球體**。平滑圓整，高頻微幅顫動；衝刺時前端極化為免疫突觸。 | **超大正圓形核**（佔據體內 $\sim 80\%$ 空間，僅留薄層胞質）。 | **穿孔素長矛**<br>(Perforin Lance) | **【殺手 T 起點中心】**<br>(右側 · 移速/暴擊/穿透) | 單局吞噬消滅 200 隻病原體<br>(`ach_engulf_20`) |
