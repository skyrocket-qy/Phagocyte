...
- **解鎖條件**：通關任意器官地圖的「急性危象（Hard 難度）」，達成成就【創口清道夫：膿毒終結】（`ach_wound_hard_clear`）。
- **生物學世界觀**：
...
### 3.4 無盡同屏上限與動態吞噬通量 (Endless Screen Cap & Kill-Driven Loop)
...
| **【微管硬化】** | 骨架微絲聚合受阻 | 禁止使用「脫水穿梭避險模式（Squeeze Mode）」。 | $+35\%$ |
...
1. **終末慢性病歷單 (Chronic Pathology Chart)**：
   - 專屬的金色全息病歷外觀，詳細記錄本次挑戰所勾選的詞綴、存活時長、超武配裝與總吞噬數。
