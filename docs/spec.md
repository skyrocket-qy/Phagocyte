...
- **打破通關同質化**：秒怪極速的超武高輸出 Build 殺怪越快、回補刷新越快，15 分鐘通關可擊殺 **5,000～8,000+ 隻**；消極苟活防守 Build 因場上滿額不回補，僅能擊殺 **800～1,200 隻**。兩者結算積分可拉開 **5～8 倍級距**，徹底區分玩家實力與 Build 擊殺通量（KPM）（詳見 `docs/map.md` 與 `docs/record.md`）。
